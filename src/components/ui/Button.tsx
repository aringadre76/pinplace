...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseClasses = 'font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 active:scale-95 min-h-[44px] flex items-center justify-center';
